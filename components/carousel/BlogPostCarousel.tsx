...
const BlogPostCarousel = () => {
  ...
  return (
    <section className="bg-neutral-100 py-8 w-screen" ref={ref}>
...
const Post = ({ imgUrl, author, title, description }: PostType) => {
  return (
    ...
    >
      ...
      <p className="mt-1.5 text-lg text-black font-medium">{title}</p>
