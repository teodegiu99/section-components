...
const TerminalContact = () => {
  ...
  return (
    <section
      ...
      className="px-8 py-12 bg-violet-600 w-screen"
    >
      <div
        ref={containerRef}
        onClick={() => {
        ...
        className="h-96 noscrollbar overflow-hidden bg-slate-950/70 backdrop-blur rounded-lg w-full max-w-3xl mx-auto overflow-y-scroll shadow-xl cursor-text font-mono"
      >
