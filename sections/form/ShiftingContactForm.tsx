...
const ShiftingContactForm = () => {
  ...
  return (
    <section className="w-screen flex">
      <div className="w-screen max-w-6xl mx-auto shadow-lg flex flex-col-reverse lg:flex-row rounded-lg overflow-hidden">
...
const Form = ({
  ...
  return (
    <form
      ...
      className={`p-10 w-full text-white transition-colors duration-[750ms] ${
    ...
    >
      ...
      <div className="mb-6">
        ...
        <textarea
          ...
          className={`${
            selected === "company" ? "bg-indigo-700" : "bg-violet-700"
          } transition-colors duration-[750ms] min-h-[150px]  placeholder-white/70 p-2 rounded-md w-full focus:outline-0`}
        />
      </div>
