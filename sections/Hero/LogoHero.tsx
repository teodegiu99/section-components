  ...
  return (
    <section className="bg-white  pb-12">
      <div className="w-full px-8 py-12 md:py-20 flex flex-col items-center">
        <h1 className="text-center text-black text-2xl md:text-6xl max-w-xl font-semibold">
          The easiest way <br/> to scale your analytics
        </h1>
        <p className="text-center text-black max-w-xl my-6">
