...
export const GridHoverHero = () => {
  ...
  return (
    <div className="bg-neutral-950 h-[700px]">
      <div
        ref={scope}
        className="grid h-full w-screen grid-cols-[repeat(auto-fit,_minmax(75px,_1fr))] grid-rows-[repeat(auto-fit,_minmax(75px,_1fr))]"
      >
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center p-8">
        <h1 className="text-center text-6xl font-black uppercase text-white sm:text-7xl md:text-8xl">
          Enter the void
        </h1>
        ...
        <button className="pointer-events-auto bg-indigo-400 z-99999 px-4 py-2 text-xl font-bold uppercase text-neutral-950 mix-blend-difference">
          Join waitlist
        </button>
      </div>
    </div>
